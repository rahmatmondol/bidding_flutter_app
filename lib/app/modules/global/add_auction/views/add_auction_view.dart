                        ...
                        InkWell(
                          onTap: () async {
                            ...
                            if (pickedFiles != null && pickedFiles.isNotEmpty) {
                              ...
                              print(
                                  controller.customerCreateAuction.toString());
                            } else {
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(
                              color:
                                  LightThemeColors.whiteColor.withOpacity(0.5)),
                              ...
                              child: DropdownButton(
                                  ...
                                  onChanged: (newValue) {
                                    ...
                                    if (selectedZone != null &&
                                      ...
                                      controller.categoryyIds.value =
                                          newValue.toString();
                                      controller.categooryId = selectedZone.id;
                                      controller
                            ...
                            child: Center(
                              child: controller.isSubCategoryLoading.value
                                  ...
                                  : DropdownButton(
                                      ...
                                      items: (controller.subCategoryModel.value
                                                  .data ??
                                              [])
                                          .map((mapValue) {
                                        return DropdownMenuItem(
                          ...
                          child: DropdownButton(
                              ...
                              items:
                                ...
                                return DropdownMenuItem(
                                  value: mapValue,
                                  child:
                                      Center(child: Text(mapValue.toString())),
                                );
                              }).toList(),
                              onChanged: (newValue) {
                                controller.selectedCurrency.value =
                      ...
                      child: Padding(
                        ...
                        child: Center(
                          child: DropdownButton(
                              dropdownColor: LightThemeColors.secounderyColor,
                              alignment: Alignment.centerLeft,
                              value: controller.selectedLevelList.value.isEmpty
                                  ? null
                                  : controller.selectedLevelList.value,
                              style: TextStyle(color: Colors.white),
                              isExpanded: true,
                              ...
                              items:
                                  (controller.levelList.value).map((mapValue) {
                                return DropdownMenuItem(
                                  value: mapValue,
                                  child:
                                      Center(child: Text(mapValue.toString())),

          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                //                     onTap: () {
                //                       Get.toNamed(
                //                           Routes.CUSTOMER_SERVICE_DETAILS);
                //                     },
                //                   ),
                //                 );
                //               }),
               ...
               SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: controller.getCustomerModel.value.data?.data?.length,
                          itemBuilder: (context, index) {
                            final customeData = controller.getCustomerModel.value.data?.data?[index];
                            ...
                            if (customeData != null) {
                              return Container(
                                ...
                                child: PopularServiceCard(
                                  ...
                                  priceLevel:
                                      "${customeData.priceType} Price- ${customeData.level} level",
                                  price: "${customeData.price} ${customeData.currency!.toUpperCase()} ",
                                  skill: customeData.skill?.toString() ?? '',
                                  description: "",
                                  onTap: () {
                                    Get.to(CustomerServiceDetailsView(
                                        customeData.id));

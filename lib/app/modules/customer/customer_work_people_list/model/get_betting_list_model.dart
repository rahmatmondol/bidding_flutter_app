...
GetBettingListModel getBettingListModelFromJson(String str) =>
    GetBettingListModel.fromJson(json.decode(str));

String getBettingListModelToJson(GetBettingListModel data) =>
...
class GetBettingListModel {
  ...
  factory GetBettingListModel.fromJson(Map<String, dynamic> json) =>
      GetBettingListModel(
        success: json["success"],
        status: json["status"],
        message: json["message"],
        data: json["data"] == null
            ? []
            : List<Betting>.from(json["data"].map((x) => Betting.fromJson(x))),
      );

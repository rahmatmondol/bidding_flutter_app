              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    children: [
                      Visibility(
                        visible: controller.skills.isNotEmpty,
                        child: Container(
                  ...
                  //*********************** */
                  Text(
                    "What is the full amount you’d like to bid for this posting?",
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Obx(
                                () => controller.isFixedPrice.value
                                    ? Text(
                                        '${controller.currency} ${controller.amount.value}',
                                        // Changed from price to amount.value
                      ...
                      // Service Fee Section with dynamic commission percentage
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              "Service Fee (${controller.commission.value}%)",
                              style: kSubtitleStyle,
                            ),
                            Obx(() => Text(
                                  '${controller.currency} ${controller.serviceFee.value.toStringAsFixed(2)}',
                                  style: kSubtitleStyle,
                                )),
                          ],
                        ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Obx(() => Text(
                                '${controller.currency} ${controller.finalAmount.value.toStringAsFixed(2)}',
                                style: kTitleTextstyle.copyWith(
                                  fontSize: 15.5.sp,
                                  color: LightThemeColors.primaryColor,
                                ),
